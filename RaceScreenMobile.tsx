...
const RaceScreenMobile: React.FC<RaceScreenMobileProps> = ({ raceData, lapCount, trackStatusInfo, drsStatus, viewName }) => {
  ...
  return (
    <div className="race-mobile-container">
        ...
        />
        <div className="card race-mobile-card">
...
export default RaceScreenMobile;