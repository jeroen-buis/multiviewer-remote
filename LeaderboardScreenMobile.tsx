...
const LeaderboardScreenMobile: React.FC<LeaderboardScreenProps> = ({ f1LiveTimingState, lapCount, trackStatusInfo, drsStatus, viewName }) => {
  ...
  const leaderboardHelpContent = (
    <>
        <p>
            The Leaderboard screen provides a real-time overview of the race standings, showing each driver's position and critical timing data. The table is horizontally scrollable.
        </p>
        <h3>Understanding the Data</h3>
        <ul>
            <li>
                <strong>Last Lap:</strong> A <strong><span style={{ color: 'var(--success-color)' }}>green</span></strong> pill indicates a personal best lap; a <strong><span style={{ color: '#9c27b0' }}>purple</span></strong> pill indicates the fastest lap of the race.
            </li>
            <li>
                <strong>Best Lap:</strong> The driver's personal best lap. A <strong><span style={{ color: '#9c27b0' }}>purple</span></strong> pill indicates this is also the fastest lap overall.
            </li>
            <li>
                <strong>Interval:</strong> The time gap to the driver ahead. A <strong>green border</strong> means the driver is catching the car in front.
            </li>
            <li>
                <strong>Gap:</strong> The time gap to the race leader. For the leader, this shows the current lap count.
            </li>
            <li>
                <strong>Gain (Race Only):</strong> Positions gained (<span style={{ color: 'var(--success-color)' }}>green</span>) or lost (<span style={{ color: 'var(--error-color)' }}>red</span>) compared to their start position.
            </li>
            <li>
                <strong>Tires:</strong> A sequence of tire icons representing the compounds used. Tap on the icons to open a tooltip with a detailed history of each tire set, including stint length and whether it was new or used.
            </li>
            <li>
  ...
  return (
    <div className="leaderboard-mobile-container">
        <SimpleHeader
            lapCount={lapCount}
        ...
        />
        <div 
            className="card leaderboard-mobile-card" 
            ref={cardRef} 
...
export default LeaderboardScreenMobile;